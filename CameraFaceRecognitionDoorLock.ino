//This code is working 100% and it is opening the door lock and turn on the esp32 cam led when face is detected.
...
//const char* ssid = "TurkTelekom_TP06AA_2.4GHz";
//const char* password = "394rgzum49zK";
